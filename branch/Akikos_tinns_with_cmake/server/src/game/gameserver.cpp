...
/*
	...
	REASON: - Due the new structure for chatsystem, changed HandleGameChat(Client, Packet);
		  to Chat->HandleGameChat(Client, Packet);
	...
	REASON: - added set timeout to 10 msec (for ReadSetTCP select) in Start() to avoid useless 100% CPU use
