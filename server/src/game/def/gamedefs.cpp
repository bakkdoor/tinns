...
bool PGameDefs::Init()
{
  ...
  Res |= mSubSkillsDefs.Load ("Subskills", "defs/subskill.def");
  Res |= mSkillsDefs.Load ("Skills", "defs/skills.def");
  Res |= mCharKindsDefs.Load ("Char kinds", "defs/charkinds.def");
...
/*
  ...
  Res |= mDammagesDefs.Load ("Dammage", "defs/dammage.def");
  ...
  Res |= mItemResDefs.Load ("Item restrictions", "defs/itemres.def");
  Res |= mNpcDefs.Load ("NPC", "defs/npc.def");
  Res |= mNpcArmorsDefs.Load ("NPC Armors", "defs/npcarmor.def");
  Res |= mNpcGroupSpawnsDefs.Load ("NPC group spawns", "defs/npcgroupspawn.def");
  Res |= mNpcLootsDefs.Load ("NPC loots", "defs/npcloot.def");
  ...
  Res |= mVehiclesDefs.Load ("Vehicles", "defs/vehicles.def");
  Res |= mVehiculeSeatsDefs.Load ("Vehicle seats", "defs/vehiclesits.def");
*/
  return ( Res );
}
